-- Forever N Co. Database Schema Creation Script (Updated)
-- Run this script in your PostgreSQL database to create all required tables
-- NOTE: Testimonials table removed - using Google Reviews integration instead
...
BEGIN
    ...
    RAISE NOTICE '📊 Tables created: users, weddings, vendors, packages, cart_items, guests';
    ...
    RAISE NOTICE '📝 Note: Testimonials replaced with Google Reviews integration';
