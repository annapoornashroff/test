    ...
    <section className="py-20 bg-gradient-to-br from-primary via-primary-600 to-primary-700 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Upload Area */}
          <div className="bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-3xl p-16 mb-8 hover:bg-white/20 transition-all duration-300 cursor-pointer group">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Button size="lg" variant="outline" className="bg-white/20 border-white/30 text-white hover:bg-white/30 rounded-full">
              Browse Gallery
            </Button>
