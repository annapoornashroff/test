...
export default function USPSection() {
  ...
  const handleFeatureClick = async (index: number, path: string) => {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="bg-pink-50 rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group cursor-pointer"
              onClick={() => handleFeatureClick(index, feature.path)}
            >
