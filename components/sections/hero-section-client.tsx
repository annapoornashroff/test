...
export default function HeroSectionClient() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex flex-col items-center justify-center h-[calc(100vh-180px)] text-center text-white px-6">
        <h1 className="text-5xl md:text-6xl font-serif font-extrabold mb-6 drop-shadow-lg leading-tight">
          Your Dream Wedding, Perfectly Planned.
        </h1>
        <p className="text-xl md:text-2xl mb-8 max-w-2xl opacity-90 drop-shadow-md">
          Find trusted vendors, manage your guest list, and track your budget with ease.
        </p>

        {/* Search Bar */}
        <div className="w-full max-w-md bg-white rounded-full shadow-lg overflow-hidden flex items-center p-2">
          ...
          />
          <Button 
            className="bg-gold hover:bg-gold-600 text-white rounded-full px-6 py-3 text-base font-semibold"
